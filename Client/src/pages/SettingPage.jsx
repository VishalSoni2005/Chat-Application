...
const PREVIEW_MESSAGES = [
  { id: 1, content: "I can do anything for you my Love!", isSent: false },
  { id: 2, content: "Oh, First Get Fair ...", isSent: true }
];
...
const SettingsPage = () => {
  ...
  return (
    <div className="container mx-auto h-auto max-w-5xl px-4 pt-20">
      <div className="space-y-6">
        {/* Theme Section */}
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold">Theme</h2>
          <p className="text-base-content/70 text-sm">Selected Themes For You</p>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2 sm:grid-cols-6 md:grid-cols-8">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`group flex cursor-pointer flex-col items-center gap-1.5 rounded-lg p-2 transition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/50"} `}
              onClick={() => setTheme(t)}>
              <div className="relative h-8 w-full overflow-hidden rounded-md" data-theme={t}>
                <div className="absolute inset-0 grid grid-cols-4 gap-px p-1">
                  <div className="bg-primary rounded"></div>  
                  {/* div have different bg-primary color for each theme */}
              ...
              <div className="bg-base-100 overflow-hidden rounded-xl shadow-sm">
                ...
                <div className="border-base-300 bg-base-100 border-b px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium">Paglu</h3>
